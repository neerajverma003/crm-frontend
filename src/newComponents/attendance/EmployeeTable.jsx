...
const AdminAttendance = ({ searchText, isEmployeeView = false }) => {
    ...
    const [remarksList, setRemarksList] = useState([{ title: "", amount: "", type: "Amount", isSaved: false }]);
    ...
    /* 💾 Save Salary Summary */
    /* -------------------------------------------------------------------------- */
    const saveSalarySummary = async (monthlyBaseSalary, perDaySalary, stats, earnedAmount, totalRemarkAmount, totalPayable) => {
        if (!selectedUser?._id) {
                                                    ...
                                                    <div className="space-y-2 text-sm sm:space-y-2.5 md:space-y-3">
                                                        ...
                                                        {(globalRole === "superadmin" || globalRole === "admin") && (
                                                            <div className="mt-4 flex flex-col gap-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
                                                                ...
                                                                <button
                                                                    onClick={() => saveSalarySummary(monthlyBaseSalary, perDaySalary, stats, totalEarned, totalRemarkAmount, finalPayable)}
